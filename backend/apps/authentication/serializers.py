...
class UserSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ('id', 'username', 'email', 'first_name', 'last_name',
                  'phone', 'is_verified', 'is_staff', 'is_superuser', 'is_active',
                  'created_at', 'updated_at')
        read_only_fields = ('id', 'username', 'is_verified', 'is_staff', 'is_superuser',
...
class UserWithProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ('id', 'username', 'email', 'first_name', 'last_name',
                  'full_name', 'phone', 'is_verified', 'is_staff', 'is_superuser',
